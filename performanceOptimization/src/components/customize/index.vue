<template>
  <div class="customize" :style="highLevel" v-show="isOpen" @touchstart="isShow($event)">
    ...
    <div class="half_icon" v-show="isIconShow" @click="expandNavBar">
      ...
      <span style="position: fixed;top: 5px;   left: 50%;transform: translate(-50%);color:#00f6c1">菜单</span>
      <img
        :src="nav_icon[8]"
