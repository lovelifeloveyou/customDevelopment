            ...
            <div class="regulate">
              <span @click="decreaseSize">
                <img
                  ...
                  src="https://reso.dalongyun.com/yun/dalongyun_page/webRtc/cloudComputerComponent/floatBall/mouseComp/鼠标选项_滚轮上.png"
                />
              </span>
              ...
              <span @click="increaseSize">
                <img
                  style="width: 30px; transform: rotate(-90deg);"
                  src="https://reso.dalongyun.com/yun/dalongyun_page/webRtc/cloudComputerComponent/floatBall/mouseComp/鼠标选项_滚轮下.png"
                />
              </span>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      show_dialog: false,
      exitImg: "https://reso.dalongyun.com/yun/dalongyun_page/webRtc/cloudComputerComponent/floatBall/roller/保存设置_关闭.png",
      // 是否删除状态
      isDelete: false,
      dynamicBtnStyle: {},
      dragBoxStyle: {},
      ...
      roller_img: [
        ...
        'https://reso.dalongyun.com/yun/dalongyun_page/webRtc/cloudComputerComponent/floatBall/roller/middle.png'
      ],
      directionStyle: {},
      changeSizeStyle: {},
