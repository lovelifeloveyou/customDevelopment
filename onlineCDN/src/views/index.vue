<template>
    ...
    >
        ...
        <div v-show="show_customize_div" class="show_customize">
    ...
    export default {
        ...
        data() {
            return {
                ...
                showFullScreenSwitch: false, // 全屏显示开关
                cus_exit: false,
                showDrag: false,
                ...
                numKey: [
                    ...
                    {key: "2", keyCode: 50},
                    {key: "3", keyCode: 51},
                    {key: "左", keyCode: 189,len: 1},
                    {key: "0", keyCode: 48},
                    {key: "右", keyCode: 187,len: 1},
                ],
                ...
                changeKeyboard: {tabIndex: 0, keyboardIndex: ''}, // 切换的键盘index
                isShowBtn: true, // 游戏键盘导航栏
                timer: null,
            ...
            judgeTouchStart() {
                if (this.judgeTouchStart) {
                    if (!this.isSidwbar && this.panel) {
                        ...
                        this.signKey = false;
                        this.SpeKey = false;
                        this.keyShow = !(this.showNavBar || this.editKeyboard || this.quitOfficialKeyboard)
        ...
        methods: {
            ...
            btnSelf(item, index) {
                ...
                this.keyShow = false;
                this.changeKeyboard = {tabIndex: 1, keyboardIndex: index};
                this.officialKeyboardFlag = "";
                let keyInfo = "";
                keyInfo =
            ...
            keySort(item, index) {
                ...
                localStorage.setItem("saveUserBehavior", JSON.stringify(realData))
                this.changeKeyboard = {tabIndex: 0, keyboardIndex: index};
            ...
            goKeyboardList() {
                // if (this.changeKeyboard.tabIndex === 0) { // 官方
                //     this.exitKey()
                // } else { // 自定义
                //     this.cus_exitFn()
                // }
...
<style lang="less" scoped>
    ...
    .exitBtn_cus:first-child {
        border-radius:25px 0 0 25px;
    }
    .exitBtn_cus:last-child {
        margin-right: 0;
